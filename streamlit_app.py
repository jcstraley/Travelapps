...
st.title("Week 1 - Data and visualization (JC Straley)")
...
st.markdown("Below is a map showing all the Airbnb listings with a red dot and the EYE Filmmuseum (our selected place of interest) with a blue dot.")
